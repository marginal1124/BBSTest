...
<!-- 是由链接跳转过来的，而且URL 中传递了id 所以需要接受id -->
...
//这里需要把String 转化为 int 类型。。。。需要判断是否可以转。。。
int rootId = Integer.parseInt(strId);
                ...
                <div class="jive-messagebox">
                   ...
                   <%
                     for(int index = 0;index < articles.size();index++){
    	                  Article aa = articles.get(index);
    	                  String  str = index ==0?"楼主":"第"+ index +"楼";  	                
                   %>
                      ...
                      <tr id="jive-message-780144" class="jive-odd" valign="top">
                        ...
                        <td class="jive-last" width="99%"><table border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tbody>
                              <tr valign="top">
                                <td width="1%"></td>
                                <td width="97%"><span class="jive-subject"> <%=str +"-----"+ aa.getTitle() %></span> </td>
